...
import { generateTaskPlan } from "@/lib/ai-tools.functions";
...
export const Route = createFileRoute("/task-planner")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Generate detailed task plans with AI." },
    ],
  }),
  ...
  const handleGenerate = async () => {
    ...
    try {
      const result = await generate({
        data: { goal, context, constraints: constraints || undefined },
      });
  ...
  return (
    <div className="mx-auto max-w-3xl space-y-6">
      ...
      <div className="space-y-4 rounded-xl border bg-card p-5">
        <h2 className="font-semibold text-card-foreground">Plan Details</h2>
        <div className="space-y-2">
          <Label htmlFor="goal">Goal</Label>
          <Input
            id="goal"
            placeholder="e.g., Launch new product feature by end of Q2"
            value={goal}
        ...
        <div className="space-y-2">
          ...
          <Textarea
            id="context"
            placeholder="Provide background information, team size, resources available..."
            value={context}
        ...
        <div className="space-y-2">
          ...
          <Textarea
            id="constraints"
            placeholder="Any deadlines, budget limits, or other constraints..."
            value={constraints}
        ...
        <Button
          ...
          disabled={isLoading || !goal || !context}
          className="w-full"
        >
          {isLoading ? (
            <>
